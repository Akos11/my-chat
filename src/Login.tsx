...
export class Login extends Component {
    ...
    render() {
        return (
            <div className="login">
                <img src="logo512.png" width="256" alt ="not loaded"/>
                <TextInput type="email" placeholder="Email (someone@example.com)" value={this.state.email} onChange={
                    e => {
                        this.setState({ email: e});
                        
                        if (e === "DKILK6" && this.state.register) {
                            this.setState({ displayName: "Ákos" }, () => {console.log(this.state);this.forceUpdate()});
